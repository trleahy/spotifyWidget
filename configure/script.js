...
const baseURL = "https://trleahy.github.io/spotifyWidget";
...
async function fetchAccessToken(code) {
  ...
  if (response.ok) {
    ...
    browserSourceURL = `${baseURL}/widget?client_id=${client_id}&client_secret=${client_secret}&refresh_token=${refresh_token}`;
